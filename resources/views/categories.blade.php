                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" roles="group" aria-label="Basic Example">
                                        <button type="button" id="btn-edit-categories" class="btn" data-toggle="modal" data-target="#modalEdit" data-id="{{ $key->id }}" data-nama="{{ $key->nama }}" data-jenis="{{ $key->jenis }}" data-keterangan="{{ $key->keterangan }}"><i class="fa fa-edit"></i></button>
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin.kategori.submit') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukan jenis barang" name="jenis" id="jenis" required />
                    </div>
                    <div class="form-group">
                ...
                <form method="post" action="{{ route('admin.kategori.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                <label for="edit-jenis">Jenis Obat</label>
