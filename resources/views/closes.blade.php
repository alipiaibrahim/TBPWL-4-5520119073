            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin.keluar.submit') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input min="1" type="number" class="form-control" name="tanggal" id="tanggal" required />
                    </div>
                    <div class="form-group">
                        <label for="jumlah">Jumlah</label>
                        <textarea class="form-control" aria-label="With textarea" placeholder="Masukan jumlah" name="jumlah" id="jumlah" required></textarea>
                    </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input min="1" type="number" class="form-control" name="tanggal" id="edit-tanggal" required />
                            </div>
                            <div class="form-group">
                                <label for="edit-jumlah">Jumlah</label>
                                <textarea class="form-control" aria-label="With textarea" name="jumlah" id="edit-jumlah" required></textarea>
                            </div>
                        </div>
                    </div>
            </div>
